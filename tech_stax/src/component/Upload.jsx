...
const Upload = () => {
  ...
  const getData = () => {
    return axios
      .get(`https://backenddeploy-techstax.onrender.com/workflowid`)
      .then((res) => {
  ...
  const handleFileInput = (e) => {
    setSelectedFile(e.target.files); // Capture files from file input
  };

  const uploadcsv = (e) => {
    let workflow_id = document.querySelector(".selectid").value;
    const filesToUpload = selectedFile || file; // Use either drag-and-drop files or file input
